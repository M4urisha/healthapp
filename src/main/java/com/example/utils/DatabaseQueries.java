...
public class DatabaseQueries {
    ...
    public List<Food> getFoodItems() {
        ...
        try (Connection connection = DatabaseConnection.connect();
             ...
             ResultSet resultSet = statement.executeQuery("SELECT food_name, calories_per_serving FROM food")) {
    ...
    public List<Exercise> getExerciseItems() {
        ...
        try (Connection connection = DatabaseConnection.connect();
             Statement statement = connection.createStatement();
             ResultSet resultSet = statement.executeQuery("SELECT exercise_name, calories_burned FROM exercise")) {
            while (resultSet.next()) {
